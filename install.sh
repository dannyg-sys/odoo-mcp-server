...
#   2. the `odoo` command (smart front door) -> ~/.local/bin/odoo  (symlink to build/cli.js)
#   3. the `manage_odoo` command (raw engine) -> ~/.local/bin/manage_odoo (symlink to scripts/manage_odoo.sh)
#
